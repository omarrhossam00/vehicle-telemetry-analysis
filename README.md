...
[2012 Opel OBD-II Driving Dataset (Kaggle)](https://www.kaggle.com/) — ~789k rows of logged OBD-II signals (RPM, speed, throttle position, engine load, coolant/intake temp, torque, power, fuel usage) across multiple driving sessions.
